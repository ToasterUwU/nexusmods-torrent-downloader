The idea is to make a program that registeres as a link handler for NexusMods downloads, and then gives out torrent files for these exact files for faster downloads.
